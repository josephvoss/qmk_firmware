...
//    LGUI_T(KC_A),   LALT_T(KC_S),   LCTL_T(KC_D),   LSFT_T(KC_F),   KC_G,   KC_H,   LSFT_T(KC_J),   LCTL_T(KC_K),   LALT_T(KC_L),   LGUI_T(KC_COLN),
    ...
    U_NP,   U_NP,   LT(MEDIA,   KC_ESC),   LT(NAV,   KC_TAB),   LT(MOUSE,   KC_BSPC),   LT(SYM,   KC_SPC),   LT(NUM,   KC_ENT),   LT(FUN,   KC_DEL),   U_NP,   U_NP
//    U_NP,   U_NP,   LT(MEDIA,   KC_ESC),   LT(NAV,   KC_SPC),   LT(MOUSE,   KC_TAB),   LT(SYM,   KC_ENT),   LT(NUM,   KC_BSPC),   LT(FUN,   KC_DEL),   U_NP,   U_NP
  ),
/*   Old home row w/ " in place of colon LGUI_T(KC_A),   LALT_T(KC_S),   LCTL_T(KC_D),   LSFT_T(KC_F),   KC_G,   KC_H,   LSFT_T(KC_J),   LCTL_T(KC_K),   LALT_T(KC_L),   LGUI_T(KC_QUOT),*/
/*   My modified thumb row to match lets split U_NP,   U_NP,   LT(MEDIA,   KC_ESC),   LT(NAV,   KC_TAB),   LT(MOUSE,   KC_BSPC),   LT(SYM,   KC_SPC),   LT(NUM,   KC_ENT),   LT(FUN,   KC_DEL),   U_NP,   U_NP*/
/*   Default mh row U_NP,   U_NP,   LT(MEDIA,   KC_ESC),   LT(NAV,   KC_SPC),   LT(MOUSE,   KC_TAB),   LT(SYM,   KC_ENT),   LT(NUM,   KC_BSPC),   LT(FUN,   KC_DEL),   U_NP,   U_NP*/
  [NAV] = LAYOUT_miryoku(
