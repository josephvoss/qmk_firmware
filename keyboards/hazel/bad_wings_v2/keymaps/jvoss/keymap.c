...
enum layers { BASE, MEDIA, NAV, MOUSE, SYMB, NUM, FUNC };

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_split_3x5_3(
    KC_Q             ,  KC_W            ,  KC_E             ,  KC_R            ,  KC_T           ,  KC_Y           ,  KC_U         ,  KC_I         ,  KC_O         ,  KC_P            ,
    LGUI_T(KC_A)     ,  LALT_T(KC_S)    ,  LCTL_T(KC_D)     ,  LSFT_T(KC_F)    ,  KC_G           ,  KC_H           ,  LGUI_T(KC_J) ,  LALT_T(KC_K) ,  LCTL_T(KC_L) ,  LSFT_T(KC_QUOT) ,
